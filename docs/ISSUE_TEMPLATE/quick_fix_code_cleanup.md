...
```
https://github.com/Learning-Fuze/<REPO>/compare/dev...<COMPARE BRANCH>?assignees=<REPO MAINTAINERS>&&expand=1&&template=quick_fix_code_cleanup.md&&labels=Technical%20Debt&&title=[CLEANUP]%20QUICK-FIX%20-%20Insert%20Title%20Here
```
